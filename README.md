...
| :--- | :--- | :--- |
| **[MagicKey](https://github.com/XiaoSong1223/MagicKey)** | A macOS menu bar app that makes the MacBook keyboard backlight breathe, pulse with keystrokes, and react to music. | [Download](https://github.com/XiaoSong1223/MagicKey/releases/latest) |
| **[DSH Release Guardian](https://github.com/XiaoSong1223/dsh-release-guardian)** | Deterministic release-risk checks for Git changes, with a CLI and coding-agent integrations. | [Overview](https://github.com/XiaoSong1223/dsh-release-guardian#readme) |
| **[SimSiam-YOLO](https://github.com/XiaoSong1223/SimSiam-YOLO)** | Self-supervised pre-training and progressive fine-tuning for traffic sign detection with limited labeled data. | [Experiments](https://github.com/XiaoSong1223/SimSiam-YOLO#readme) |
